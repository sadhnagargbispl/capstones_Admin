<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ApprovePoolRequest.aspx.cs" Inherits="ApprovePoolRequest" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Pool Approve Request </h3>
                            </div>
                                            ...
                                            <div id="gvContainer" runat="server" style="overflow: scroll; margin-top: 25px; margin-left: 25px; margin-bottom: 25px;">
                                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a href='<%# "Img.aspx?&type=PoolPayment&ID=" + Eval("Reqno") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe', width: 785, height: 580, marginTop: 0 })">
