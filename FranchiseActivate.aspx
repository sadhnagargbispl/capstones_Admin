<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FranchiseActivate.aspx.cs" Inherits="FranchiseActivate" %>
                 ...
                 <div class="col-12">
                     <div class="card card-primary">
                         <div class="card-header">
                             <h3 class="card-title">Franchise Investment
                                </h3>
                         </div>
                         <div class="card-body">
                              <div align="center">
                          ...
                          <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                   ...
                                   onkeypress="return isNumberKey(event);" OnTextChanged="txtAmount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                            </div>
                                        </div>
