<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FranchiseIncomeReport.aspx.cs" Inherits="FranchiseIncomeReport" %>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Franchise Income Report</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
