...
public partial class FranchiseIncomeReport : System.Web.UI.Page
{
    DAL objDAL = new DAL();
    ...
    private void ExportExcel()
    {
        try
        {
            DataTable dt = (DataTable)Session["FranchiseBonus"];
            using (XLWorkbook wb = new XLWorkbook())
            {
                wb.Worksheets.Add(dt, "FranchiseBonus");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=FranchiseBonusReport.xlsx");
    ...
    protected void GrdTotal1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            GvData1.DataSource = Session["FranchiseBonus"];
            GvData1.DataBind();
        }
        catch (Exception ex)
        {
