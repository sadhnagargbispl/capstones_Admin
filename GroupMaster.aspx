                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class=" col-md-12" style="padding: 10px;">
                                        ...
                                        <asp:Button ID="BtnAdd" runat="server" class="btn btn-primary" Text="Add Group" OnClick="BtnAdd_Click" />
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <a href='<%# "AddGroup.aspx?GroupId=" + HttpUtility.UrlEncode(Crypto.Encrypt(Eval("VGroupId").ToString())) %>'>
