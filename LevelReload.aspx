<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LevelReload.aspx.cs" Inherits="LevelReload" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Level Re-Load Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:Button ID="AddLevel" runat="server" class="btn btn-primary" Text="Level Re-Load" OnClick="AddLevel_Click" />
                                    </div>
                                </div>
