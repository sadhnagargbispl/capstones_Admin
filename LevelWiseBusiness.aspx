<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LevelWiseBusiness.aspx.cs" Inherits="LevelWiseBusiness" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Level Wise Direct </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        <label for="exampleInputEmail1">Member ID</label>
                                        <asp:TextBox ID="txtMember" runat="server"
                                            class="form-control" AutoPostBack="true" OnTextChanged="txtMember_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        <label for="exampleInputEmail1">Search Records By :</label>
