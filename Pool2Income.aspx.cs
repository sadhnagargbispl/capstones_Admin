...
public partial class Pool2Income : System.Web.UI.Page
{
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetPool2IncomeReport", prms);
            ...
            Session["Pool2IncomeReport"] = Ds.Tables[0];
            ViewState["IdNo"] = "IdNo";
    ...
    private void ExportExcel()
    {
        try
        {
            DataTable dt = (DataTable)Session["Pool2IncomeReport"];
            using (XLWorkbook wb = new XLWorkbook())
            {
                wb.Worksheets.Add(dt, "Pool2IncomeReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=Pool2IncomeReport.xlsx");
    ...
    protected void GrdTotal1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            GvData1.DataSource = Session["Pool2IncomeReport"];
            GvData1.DataBind();
        }
        catch (Exception ex)
        {
