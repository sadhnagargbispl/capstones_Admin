<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SalaryBonus.aspx.cs" Inherits="SalaryBonus" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Salary Bonus Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        Status :
                                         <asp:DropDownList ID="ddlstatus" runat="server" class="form-control">
                                             <asp:ListItem Text="--select status--" Value="0" Selected="True" />
                          <asp:ListItem Text="Paid" Value="Y" />
                                <asp:ListItem Text="Unpaid" Value="N" />
                                     </asp:DropDownList>
                                    </div>
                                    <div class="col-md-2">
                                        PageSize:
