...
public partial class SalaryBonus : System.Web.UI.Page
{
    DAL objDAL = new DAL();
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            prms[5] = new SqlParameter("@type", ddlstatus.SelectedValue);
            prms[6] = new SqlParameter("@IsExport", "N");
            prms[7] = new SqlParameter("@RecordCount", ParameterDirection.Output);
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetSalaryBonusReport", prms);
            ...
            Session["SalaryBonus"] = Ds.Tables[0];
            ViewState["IdNo"] = "IdNo";
    ...
    private void ExportExcel()
    {
        try
        {
            DataTable dt = (DataTable)Session["SalaryBonus"];
            using (XLWorkbook wb = new XLWorkbook())
            {
                wb.Worksheets.Add(dt, "LevelBonus");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=SalaryBonusReport.xlsx");
    ...
    protected void GrdTotal1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            GvData1.DataSource = Session["SalaryBonus"];
            GvData1.DataBind();
        }
        catch (Exception ex)
        {
