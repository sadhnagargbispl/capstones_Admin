...
public partial class StopWithdrawal : System.Web.UI.Page
{
    string scrname;
    string formno;
    DAL ObjDAl = new DAL();
    ...
    protected string GetName()
    {
        try
        {
            ...
            str = ObjDAl.IsoStart + "exec Sp_GetNameWithdrawal '" + txtIdno.Text + "' " + ObjDAl.IsoEnd;
    ...
    protected void FillData()
    {
        try
        {
            ...
            qry1 = ObjDAl.IsoStart + "exec Sp_GetWithdrawalData" + ObjDAl.IsoEnd;
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string Rstatus = "";
            string str = ObjDAl.IsoStart + "Select top 1 Rstatus from " + ObjDAl.DBName + "..StopWithdrawal where formno='" + hdnFormno.Value + "' order by rectimestamp desc" + ObjDAl.IsoEnd;
            DataTable dtData = new DataTable();
            ...
            if (dtData.Rows.Count > 0)
            {
                ...
                {
                    str = "exec SP_SAVEWITHDRAWAL '" + hdnFormno.Value + "','" + SelectRoi.SelectedValue + "','Y'";
                }
                else if (dtData.Rows[0]["Rstatus"].ToString() == "Y")
                {
                    str = "exec SP_SAVEWITHDRAWAL '" + hdnFormno.Value + "','" + SelectRoi.SelectedValue + "','N'";
                }
            }
            else
            {
    ...
    protected void SelectRoi_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt = new DataTable();
            string Str = ObjDAl.IsoStart + " exec Sp_GetWithdrawalBind '" + SelectRoi.SelectedValue + "','" + hdnFormno.Value + "'" + ObjDAl.IsoEnd;
            dt = SqlHelper.ExecuteDataset(constr1, CommandType.Text, Str).Tables[0];
            if (dt.Rows.Count == 0)
            {
