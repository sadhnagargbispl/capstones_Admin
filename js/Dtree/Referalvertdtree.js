...
function Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, directbv, indirectbv, totalbv) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
    ...
    this.directbv=directbv;
    this.indirectbv=indirectbv;
...
dTree.prototype.add = function (id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, directbv, indirectbv, totalbv) {
    this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, directbv, indirectbv, totalbv);
};
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
        ...
        strTable += '<tr>';
        strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Business</strong></font></td>';
        strTable += '<td ><font FACE=Verdana SIZE=1>Direct :' + node.directbv + ', Indirect :' + node.indirectbv + ',Total :' + node.totalbv + '</font> </td>';
        strTable += '</tr>';
