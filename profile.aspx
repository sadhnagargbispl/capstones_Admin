...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    ForeColor="black" Font-Bold="true" Font-Size="12px"></asp:TextBox>
        ...
        Mother's Name   
       <asp:TextBox ID="txtMnm" runat="server" TabIndex="10" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
    ForeColor="black" Font-Bold="true" Font-Size="12px"></asp:TextBox>
</div>--%>
                                                <div class="col-md-4">
                                                    Country 
    ...
    <asp:DropDownList ID="ddlCountryName" runat="server" TabIndex="35" CssClass="form-control" OnSelectedIndexChanged="ddlCountryName_SelectedIndexChanged" AutoPostBack="true">
                                                ...
                                                <div class="col-md-4" runat="server">
                                                    Pincode:
    <asp:TextBox ID="txtpincode1" CssClass="form-control" onkeypress="return isNumberKey(event);" MaxLength="6"
        TabIndex="15" runat="server"></asp:TextBox>
                                                ...
                                                <div class="col-md-4" runat="server">
                                                    ...
                                                    <asp:DropDownList ID="ddlStatename" runat="server" CssClass="form-control validate[custom[onlyLetterNumberChar]" TabIndex="8" AutoPostBack="true" OnTextChanged="ddlStatename_TextChanged">
                                                    </asp:DropDownList>
                                                    <asp:HiddenField ID="statecode1" runat="server" />
                                                </div>
                                                <div class="col-md-4">
                                                    District:
         
                <asp:HiddenField ID="HiddenField2" runat="server" />
                                                    <asp:TextBox ID="txtdistrict1" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                ...
                <asp:HiddenField ID="HiddenField3" runat="server" />
                                                    <asp:TextBox ID="txtcity1" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
 ...
 <div class="col-md-4">--%>
        ...
        <h5 style="color: Black">
            <strong>Nominee Detail</strong></h5>
                                                    <%--<div id="childdiv" runat="server" visible="false" class="row" >
    <div class="col-md-3">
       
            Child Name1
            <asp:TextBox ID="txtchild1" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                runat="server"></asp:TextBox>
    ...
    <div class="col-md-3" id="Div1" runat="server">
            ...
            Gender child1 
            <asp:RadioButtonList ID="rbtchild1type" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
    ...
    <div class="col-md-3">
            ...
            <asp:TextBox ID="txtchild2" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                runat="server"></asp:TextBox>
    </div>
    ...
    <div class="col-md-3">
            ...
            Child Name3
            <asp:TextBox ID="txtchild3" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                runat="server"></asp:TextBox>
    </div>
    ...
    <div class="col-md-3">
            ...
            Child Name4
            <asp:TextBox ID="txtchild4" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                runat="server"></asp:TextBox>
